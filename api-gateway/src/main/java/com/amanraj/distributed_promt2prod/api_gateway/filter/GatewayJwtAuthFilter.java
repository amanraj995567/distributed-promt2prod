package com.amanraj.distributed_promt2prod.api_gateway.filter;

import com.amanraj.distributed_promt2prod.api_gateway.config.SecuritiesProperties;
import com.amanraj.distributed_promt2prod.api_gateway.service.JwtGatewayService;
import com.amanraj.distributed_promt2prod.common_lib.error.ApiError;
...
public class GatewayJwtAuthFilter implements GlobalFilter, Ordered {
    ...
    private final SecuritiesProperties securityProperties;
    private final JwtGatewayService jwtGatewayService;

    private final ObjectMapper objectMapper = new ObjectMapper()
            .registeredModules(new JavaTimeModule());
