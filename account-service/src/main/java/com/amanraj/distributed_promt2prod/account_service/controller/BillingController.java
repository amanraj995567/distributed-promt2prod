...
import com.amanraj.distributed_promt2prod.account_service.dto.subscription.*;
...
public class BillingController {
    ...
    public ResponseEntity<String> handlePaymentWebhooks(
        ...
        try {
            // Construct the event and verify the signature using your Stripe Webhook Secret
            ...
            if (deserializer.getObject().isPresent()) { // happy case
                ...
                // Fallback: Deserialize from raw JSON if the version is incompatible
            ...
            if (stripeObject instanceof Session session) {
                metadata = session.getConfigurationObject().getMetadata();
            }

            // Pass to your processor to handle business logic
